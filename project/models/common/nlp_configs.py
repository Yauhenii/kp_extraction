# source https://github.com/PyTorchLightning/lightning-transformers/blob/0.1.0/lightning_transformers/core/nlp/config.py

from dataclasses import dataclass
from pathlib import Path
from typing import Optional, Union

from project.models.common.configs import DataConfig, TaskConfig


@dataclass
class HFTransformerDataConfig(DataConfig):
