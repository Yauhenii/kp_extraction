...
from project.models.baselines.losses.contrastive import ContrastiveLoss
...
class ContrastiveModel(BaseNLPModel):
    ...
    def __init__(self, backbone: HFBackboneConfig, cfg: dict, **kwargs):
        ...
        if "distance_fnc" in cfg:
            self.distance_fnc = cfg["distance_fnc"]
        ...
        self.criterion = ContrastiveLoss(self.distance_fnc, margin=self.margin)
