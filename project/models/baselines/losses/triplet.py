# source https://github.com/UKPLab/sentence-transformers/blob/master/sentence_transformers/losses/BatchAllTripletLoss.py

from torch import nn, Tensor
from project.models.baselines.losses.batch_hard_triplet import BatchHardTripletLoss, \
...
class BatchAllTripletLoss(nn.Module):
    ...
    def __init__(self, distance="euclidean", margin: float = 5):
        super().__init__()
    ...
    def batch_all_triplet_loss(self, labels, embeddings):
        ...
        pairwise_dist = self.distance_metric(embeddings, embeddings)
